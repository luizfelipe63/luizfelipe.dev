  ...
  return (
    <section className="mx-auto max-w-[1216px] pb-36 pt-20">
      <div className="space-y-4 text-center">
        ...
        <h2 className="text-center text-5xl">Conheça minha história...</h2>
      </div>
      <div className="flex justify-around gap-8 pt-20">
        <div className="w-[500px]">
          <Image src={AboutMe} alt="" className="rounded-lg" />
        </div>
        <div className="max-w-lg space-y-4 text-gray-400">
          <p>Meu nome é Jonas Milan e sou de Chapecó – SC (Brasil).</p>
          <p>
